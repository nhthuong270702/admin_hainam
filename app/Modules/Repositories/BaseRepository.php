...
use App\Modules\Repositories\Exceptions\RepositoryException;
use App\Modules\Repositories\Contracts\RepositoryContract;
use App\Modules\Repositories\Traits\Cacheable;
...
abstract class BaseRepository implements RepositoryContract
{
    ...
    /**
     * Return in random order by array.
     *
     * @return Builder
     */
    ...
    /**
     * Find first or Fail data by multiple fields
     *
     * @param array $where
     * @param array $columns
     *
